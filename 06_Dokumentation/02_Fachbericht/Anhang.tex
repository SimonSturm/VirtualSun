...
Diese Werte wurden bei maximaler Spannung gemessen (Spannung am Feedback Pin 0v) und dient dazu, zu überprüfen ob der Regler für die verlangte Anwendung geeignet ist.
\newpage
\begin{table}[h]
\centering
